...
--
-- Name: index_searches_on_grouping_and_query; Type: INDEX; Schema: ctgov; Owner: -
--

CREATE UNIQUE INDEX index_searches_on_grouping_and_query ON ctgov.searches USING btree ("grouping", query);
...
INSERT INTO schema_migrations (version) VALUES ('20200921182727');

INSERT INTO schema_migrations (version) VALUES ('20200921183334');
